...
**Стек:** Go, PostgreSQL, gRPC, REST API, Docker, Testify.  
**Особенности:** шардирование, кеширование в Redis, метрики, graceful shutdown.

### [ReviewRequest](https://github.com/J0hnLenin/ReviewRequest)
Сервис автоматического назначения ревьюверов на пул‑реквесты.  
**Стек:** Go, PostgreSQL, gRPC, REST API, Docker.

### [Tesuji](https://github.com/J0hnLenin/Tesuji)
Веб-приложение для просмотра партий игры Го в реальном времени (reverse‑engineering протоколов KGS).  
**Стек:** Go, PostgreSQL, Redis, Kafka, gRPC, Vue, Docker, GitHub Actions.  
**Особенности:** потоковая обработка, асинхронность, CI/CD.
